...
function CardVideo({video,setDelStatus,cat}) {
    ...
    return (
        <>
            <Card style={cat?{width:"15rem"}:{width:"25rem"}} className='ms-3 mb-3' draggable onDragStart={(e)=>{handleOnDrag(e,video?.id)}}>
                ...
                <Card.Body className='d-flex flex-row justify-content-between'>
                    ...
                    <i className="fa-solid fa-trash fa-xl" onClick={()=>{handleDelete(video.id)}} style={{ color: '#f00a0a' }}></i>
                    }
